...
class DispatchResultTest extends TestCase
{
    ...
    public function testRecordSuccess(): void
    {
        ...
        $this->assertEquals(['handler' => $handler, 'return_value' => 'result'], $result->getSuccesses()[0]);
    }
    ...
    public function testRecordFailure(): void
    {
        ...
        $this->assertEquals($handler, $result->getFailures()[0]['handler']);
    ...
    public function testConvertToArray(): void
    {
        ...
        $this->assertEquals('order.created', $array['event_type']);
        $this->assertEquals(2, $array['handler_count']);
        ...
        $this->assertEquals(1, count($array['failures']));
    }
    ...
    public function testSerializeClosureHandler(): void
    {
        ...
        $array = $result->toArray();
        $this->assertEquals('Closure', $array['failures'][0]['handler']);
    }
    ...
    public function testSerializeStringHandler(): void
    {
        ...
        $array = $result->toArray();
        $this->assertEquals('my_function', $array['failures'][0]['handler']);
    }
}
